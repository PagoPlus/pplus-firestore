defmodule PPlusFireStore.RepoTest do
  ...
  describe "get repo settings" do
    ...
    test "returns the base path" do
      project_id = Application.get_env(:my_app, TestFireStoreRepo)[:project_id]
      database_id = Application.get_env(:my_app, TestFireStoreRepo)[:database_id]
      assert TestFireStoreRepo.base_path() == "projects/#{project_id}/databases/#{database_id}/documents"
    end
  end
